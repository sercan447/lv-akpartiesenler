...
<body class="skin-dark">
	...
	<header class="header">
		...
		<!--	<img src="{{ asset('backend/assets/img/logo.png') }}" alt="BSM Teknoloji" height="20"> -->
		</a>
		<!-- END LOGO -->
		<!-- BEGIN NAVBAR -->
		...
		@php
			$veriler = App\Model\HaberlerModel::limit(5)->orderBy("id","DESC")->get();
		@endphp	
			<!-- BEGIN NEWS TICKER -->
			<div class="ticker">
			...
			<!-- END NEWS TICKER -->
				<?php
					$bugunki_iletisim = App\Model\MusterilerModel::orderBy("numara","DESC")->get();
				?>
			<div class="navbar-right">
				<ul class="nav navbar-nav">
					<?php
							$tarih_bugun = date("Y-m-d");
							$musteri_sayi = App\Model\MusterilerModel::whereDate("created_at",$tarih_bugun)->orderBy("numara","DESC")->get();
					?>
					...
					<li class="dropdown profile-menu">
						...
						<ul class="dropdown-menu box profile">
							<li><div class="up-arrow"></div></li>
							<li >
								<a href="{{URL('/')}}" target="_blank"><i class="fa fa-eye"></i>Siteye Git</a>
							</li>
							<!--
								<li class="border-top">
							...
							-->
							<li class="border-top">
								<a href="{{route('kilitlisistem') }}"><i class="fa fa-lock"></i>Kilitle</a>
							</li>
							...
							<li>
								...
								<a class="dropdown-item" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
													 ...
													 <i class="fa fa-sign-out"></i> Sistemden Çıkış
                                 </a>
		...
		<aside class="left-side sidebar-offcanvas">
			<section class="sidebar">
				<div class="user-panel">
					<div class="pull-left">
					<!--	<img src="{{asset('backend/image/logo-inline.png')}}" 
					 width="245" height="150"  class="img-circle" alt="User Image">
					 -->
					</div>
				...
				<ul class="sidebar-menu">
					...
					<li class="active">
						<a href="{{route('admmusteriler')}}">
							<i class="fa fa-reorder"></i><span>Katılma İstekleri</span>
						</a>
					</li>
					<li class="active">
					...
					<li class="active">
						<a href="{{route('admfirmabilgi')}}">
							<i class="fa fa-info"></i><span>Bilgi Alanı</span>
						</a>
					</li>
					<li class="active">
					...
					<li class="active">
						<a href="{{route('admvideoekle')}}">
							<i class="fa fa-ellipsis-h"></i><span>Video Ekle</span>
						</a>
					</li>
					<li class="active">
						<a href="{{route('admvideolar')}}">
							<i class="fa fa-ellipsis-h"></i><span>Videolar</span>
						</a>
					</li>
					<!--
					<li class="active">
						<a href="{{ route('admkategoriekle') }}">
							<i class="fa fa-users"></i><span>Kategori Ekle</span>
						</a>
					</li>
					-->
					<li class="active">
						<a href="{{ route('admpersoneller') }}">
							<i class="fa fa-users"></i><span>Personeller</span>
						</a>
					</li>
					<li class="active">
						<a href="{{ route('admpersonelekle') }}">
							<i class="fa fa-users"></i><span>Personel Ekle</span>
						</a>
					</li>
